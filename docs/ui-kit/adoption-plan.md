...
Audit duplicate primitives, duplicate CSS, token violations, inconsistent states, accessibility gaps and equivalent components with different names. Reconcile Map components from the parallel Map repository before migration. Fix only confirmed inconsistencies.
